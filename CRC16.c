...
/*
Функции для проверки контрольной суммы по алгоритму CRC16
*/

/* CRC16 Table High byte */
 const static unsigned char CRC16Hi[] = {
...
{
	unsigned char Index ; /* will index into CRC16 lookup table */
